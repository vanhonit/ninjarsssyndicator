...
class NinjaRssSyndicatorModelninjarsssyndicator extends JModelLegacy
{
		...
		*/
		...
		switch (strtolower( $feed->msg_orderby )) {
			...
			case 'mrdate':
				...
				break;
			case 'catsect':
				$orderby = intval($FPItemsOnly)==1 ? "f.ordering, a.ordering ASC, a.catid" : "a.ordering ASC, a.catid";
				break;
			case 'artord':
				$orderby = "a.ordering";
				break;
